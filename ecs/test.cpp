...
int main() {
    ...
    entityManager.addComponent<TagComponent>(player, "tag", "player");
    ...
    entityManager.addComponent<TagComponent>(enemy2, "tag", "enemy");
    ...
    entityManager.addComponent<TagComponent>(enemy3, "tag", "enemy");
